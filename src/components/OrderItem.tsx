...
function OrderItem({ id, amount, items, timestamp, images}: Order) {
  return (
    <div className="relative border rounded-md">
        <div className="flex items-center space-x-10 p-5 bg-gray-100 text-sm text-gray-600">
            ...
            <div>
                ...
                <p> <Currency quantity={amount} currency="USD"/> - Next Day Delivery</p>
            </div>
        ...
        <div className="p-5 sm:p-10">
            <div className="flex space-x-6 overflow-x-auto">
                {images.map((image)=> (
                    <img src={image} alt="item" className="h-20 object-contain sm:h-32"/>
                ))}
            </div>
        </div>
    </div>
